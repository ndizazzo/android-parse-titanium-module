...
// This proxy can be created by calling AndroidParseTitaniumModule.createExample({message: "hello world"})
@Kroll.proxy(creatableInModule=AndroidParseTitaniumModuleModule.class)
